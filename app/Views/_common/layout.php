...
<head>
    ...
    <title>php-piads Sistema de controle financeiro</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        <a href="<?php echo base_url() ?>" class="navbar-brand"><img src="<?php echo base_url('assets/imagens/logo_php_exp_white.png')?>" alt="Logo" class="logo_site"></a>
